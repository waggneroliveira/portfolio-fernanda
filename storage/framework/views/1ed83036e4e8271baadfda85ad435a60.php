...
<section id=hero class="hero position-relative d-flex flex-column section dark-background overflow-hidden">
    <img id=profileImage src="<?php echo e(asset('build/client/images/bann-1.png')); ?>" alt="Banner Hero" title="Banner Hero" class="image-hero">
    <div class="group-firula">
        <div class="asteristico" data-aos="fade-up" data-aos-delay="600">
            <img src="<?php echo e(asset('build/client/images/asterisco.png')); ?>" alt="Firula Banner Hero Asteristico" title="Firula Banner Hero Asteristico" class="firula-image-hero-asteristico">
        </div>
        <img src="<?php echo e(asset('build/client/images/five-senses.png')); ?>" alt="Firula Banner Hero Asteristico" title="Firula Banner Hero Asteristico" class="firula-image-hero" data-aos="fade-up" data-aos-delay="200">
    </div>
                ...
                <div class="stack-details-slider swiper init-swiper">
                    ...
                    <div class="carousel-project swiper-wrapper align-items-center">
                        <div class=swiper-slide>
                            <img src="<?php echo e(asset('build/client/images/html.svg')); ?>" alt=Html title=Html loading=lazy>
                        </div>
                        <div class=swiper-slide>
                            <img src="<?php echo e(asset('build/client/images/css.svg')); ?>" alt=Css title=Css loading=lazy>
                        </div>
                        <div class=swiper-slide>
                            <img src="<?php echo e(asset('build/client/images/sass.webp')); ?>" alt=Sass title=Sass loading=lazy>
                        </div>
                        <div class=swiper-slide>
                            <img src="<?php echo e(asset('build/client/images/js.svg')); ?>" alt=JavaScript title=JavaScript loading=lazy>
                        </div>
                        <div class=swiper-slide>
                            <img src="<?php echo e(asset('build/client/images/jquery.svg')); ?>" alt=Jquery title=Jquery loading=lazy>
                        </div>
                        <div class=swiper-slide>
                            <img src="<?php echo e(asset('build/client/images/php.png')); ?>" alt=Php title=Php loading=lazy>
                        </div>
                        <div class=swiper-slide>
                            <img src="<?php echo e(asset('build/client/images/laravel.svg')); ?>" alt=Laravel title=Laravel loading=lazy>
                        </div>
                        <div class=swiper-slide>
                            <img src="<?php echo e(asset('build/client/images/bs.svg')); ?>" alt=Booststrap title=Booststrap loading=lazy>
                        </div>
                        <div class=swiper-slide>
                            <img src="<?php echo e(asset('build/client/images/tailwind.svg')); ?>" alt=Tailwind title=Tailwind loading=lazy>
                        </div>
                        <div class=swiper-slide>
                            <img src="<?php echo e(asset('build/client/images/vue.svg')); ?>" title=Vue loading=lazy>
                        </div>
                        <div class=swiper-slide>
                            <img src="<?php echo e(asset('build/client/images/wp.svg')); ?>" alt=WordPress title=WordPress loading=lazy>
                        </div>
                        <div class=swiper-slide>
                            <img src="<?php echo e(asset('build/client/images/git.svg')); ?>" alt=Git title=Git loading=lazy>
                        </div>
                        <div class=swiper-slide>
                            <img src="<?php echo e(asset('build/client/images/github.svg')); ?>" alt=GitHub title=GitHub loading=lazy>
                        </div>
                        <div class=swiper-slide>
                            <img src="<?php echo e(asset('build/client/images/mysql.svg')); ?>" alt=MySQL title=MySQL loading=lazy>
                        </div>
                        <div class=swiper-slide>
                            <img src="<?php echo e(asset('build/client/images/figma.svg')); ?>" alt=Figma title=Figma loading=lazy>
                        </div>
                        <div class=swiper-slide>
                            <img src="<?php echo e(asset('build/client/images/nuvemshop.svg')); ?>" alt=Nuvemshop title=Nuvemshop loading=lazy>
                        </div>
                        <div class=swiper-slide>
                            <img src="<?php echo e(asset('build/client/images/adobe.svg')); ?>" alt=Adobe title=Adobe loading=lazy>
                        </div>
                        <div class=swiper-slide>
                            <img src="<?php echo e(asset('build/client/images/instagram.svg')); ?>" alt=Instagram title=Instagram loading=lazy>
                        </div>
                        <div class=swiper-slide>
                            <img src="<?php echo e(asset('build/client/images/meta.svg')); ?>" alt=Meta title=Meta loading=lazy>
                        </div>
                        <div class=swiper-slide>
                            <img src="<?php echo e(asset('build/client/images/photoshop.svg')); ?>" alt=photoshop title=photoshop loading=lazy>
                        </div>
                    </div>
        ...
        <div class="max-width m-auto content-project d-flex flex-column flex-md-row justify-content-between align-items-baseline position-relative z-1 text-center text-md-start">
            ...
            <div class="content-right col-4" data-aos=fade-right data-aos-delay=300>
                ...
                <div data-aos=zoom-in-up data-aos-delay=300>
                    <img src="<?php echo e(asset('build/client/images/laptop.webp')); ?>" alt="Imagem computador" title="Imagem computador" class="w-100 laptop-parallax" loading=lazy>
                </div>
            </div>
        </div>
                ...
                <div class="swiper-wrapper align-items-center">
                    <div class=swiper-slide>
                        <div class="project-list-item dark-background-medium p-3">
                            <img src="<?php echo e(asset('build/client/images/ideia.svg')); ?>" alt=Icon title="Icon ideia" loading=lazy>
                    ...
                    <div class=swiper-slide>
                        <div class="project-list-item dark-background-medium p-3">
                            <img src="<?php echo e(asset('build/client/images/interativo.svg')); ?>" alt=Icon title="Icon interativo" loading=lazy>
                    ...
                    <div class=swiper-slide>
                        <div class="project-list-item dark-background-medium p-3">
                            <img src="<?php echo e(asset('build/client/images/sitema.svg')); ?>" alt=Icon title="Icon sistema" loading=lazy>
                    ...
                    <div class=swiper-slide>
                        <div class="project-list-item dark-background-medium p-3">
                            <img src="<?php echo e(asset('build/client/images/eccomerce.svg')); ?>" alt=Icon title="Icon eccomerce" loading=lazy>
                    ...
                    <div class=swiper-slide>
                        <div class="project-list-item dark-background-medium p-3">
                            <img src="<?php echo e(asset('build/client/images/marketing.svg')); ?>" alt=Icon title="Icon marketing" loading=lazy>
                    ...
                    <div class=swiper-slide>
                        <div class="project-list-item dark-background-medium p-3">
                            <img src="<?php echo e(asset('build/client/images/hospedagem.svg')); ?>" alt=Icon title="Icon hospedagem" loading=lazy>
...
<section id=portfolio class="d-flex gap-4 flex-column dark-background py-4">
    <div class="d-flex justify-content-between flex-md-row">
        <div class="carousel-top-width w-100-md position-relative" data-aos=fade-left data-aos-delay=450>
            <div class="portfolio-top-details-slider swiper init-swiper">
                ...
                <div class="portfolio-top swiper-wrapper align-items-center">
                    <div class=swiper-slide>
                        <picture>
                            <source srcset="<?php echo e(asset('build/client/images/mckup/telenordeste-mobile.webp ')); ?>" media="(max-width: 600px)" type=image/webp>
                            <source srcset="<?php echo e(asset('build/client/images/mckup/telenordeste.webp')); ?>" type=image/webp>
                            <img src="<?php echo e(asset('build/client/images/mckup/telenordeste.webp')); ?>" alt=Telenordeste title=Telenordeste loading=lazy style=width:100%;max-width:300px;height:auto;object-fit:cover;border-radius:35px>
                        </picture>
                    </div>
                    <div class=swiper-slide>
                        <picture>
                            <source srcset="<?php echo e(asset('build/client/images/mckup/sushitan-mobile.webp')); ?>" media="(max-width: 600px)" type=image/webp>
                            <source srcset="<?php echo e(asset('build/client/images/mckup/sushitan.webp')); ?>" type=image/webp>
                            <img src="<?php echo e(asset('build/client/images/mckup/sushitan.webp')); ?>" alt=Sushitan title=Sushitan loading=lazy style=width:100%;max-width:300px;height:auto;object-fit:cover;border-radius:35px>
                        </picture>
                    </div>
                    <div class=swiper-slide>
                        <picture>
                            <source srcset="<?php echo e(asset('build/client/images/mckup/pindalar-mobile.webp')); ?>" media="(max-width: 600px)" type=image/webp>
                            <source srcset="<?php echo e(asset('build/client/images/mckup/pindalar.webp')); ?>" type=image/webp>
                            <img src="<?php echo e(asset('build/client/images/mckup/pindalar.webp')); ?>" alt=Pindalar title=Pindalar loading=lazy style=width:100%;max-width:300px;height:auto;object-fit:cover;border-radius:35px>
                        </picture>
                    </div>
                    <div class=swiper-slide>
                        <picture>
                            <source srcset="<?php echo e(asset('build/client/images/mckup/depyl-mobile.webp')); ?>" media="(max-width: 600px)" type=image/webp>
                            <source srcset="<?php echo e(asset('build/client/images/mckup/depyl.webp')); ?>" type=image/webp>
                            <img src="<?php echo e(asset('build/client/images/mckup/depyl.webp')); ?>" alt=DepylCare title=DepylCare loading=lazy style=width:100%;max-width:300px;height:auto;object-fit:cover;border-radius:35px>
                        </picture>
                    </div>
                    <div class=swiper-slide>
                        <picture>
                            <source srcset="<?php echo e(asset('build/client/images/mckup/viva-ervas-mobile.webp')); ?>" media="(max-width: 600px)" type=image/webp>
                            <source srcset="<?php echo e(asset('build/client/images/mckup/viva-ervas.webp')); ?>" type=image/webp>
                            <img src="<?php echo e(asset('build/client/images//mckup/viva-ervas.webp')); ?>" alt="Viva ervas" title="Viva ervas" loading=lazy style=width:100%;max-width:300px;height:auto;object-fit:cover;border-radius:35px>
                        </picture>
                    </div>
                    <div class=swiper-slide>
                        <picture>
                            <source srcset="<?php echo e(asset('build/client/images/mckup/portfolio-mobile.webp')); ?>" media="(max-width: 600px)" type=image/webp>
                            <source srcset="<?php echo e(asset('build/client/images/mckup/portfolio.webp')); ?>" type=image/webp>
                            <img src="<?php echo e(asset('build/client/images/mckup/portfolio.webp')); ?>" alt=Protfolio title=Protfolio loading=lazy style=width:100%;max-width:300px;height:auto;object-fit:cover;border-radius:35px>
                        </picture>
                    </div>
                </div>
                <div class=swiper-pagination></div>
        ...
        <div class="rating w-100-md">
            <div class="col-7 width-md m-auto d-flex justify-content-center align-items-baseline flex-column h-100 gap-2" data-aos=fade-down data-aos-delay=450>
                <span class="rethink-sans-medium"><img src="<?php echo e(asset('build/client/images/somar.png')); ?>" alt="Icone mais" class="me-2 w-100" loading=lazy> Criatividade</span>
                <span class="rethink-sans-medium"><img src="<?php echo e(asset('build/client/images/somar.png')); ?>" alt="Icone mais" class="me-2 w-100" loading=lazy> Modernidade</span>
                <span class="rethink-sans-medium"><img src="<?php echo e(asset('build/client/images/somar.png')); ?>" alt="Icone mais" class="me-2 w-100" loading=lazy> Satisfação</span>
                <div class="clients d-flex flex-wrap mt-3">
                    <div class=client-img>
                        <img src="<?php echo e(asset('build/client/images/client-group.png')); ?>" alt="Logo de clientes" title="Logo de clientes" class=w-100 loading=lazy>
                    </div>
                </div>
    ...
    <div class="portfolio-bottom-details-slider swiper init-swiper" data-aos=fade-right data-aos-delay=350>
        ...
        <div class="portfolio-bottom swiper-wrapper align-items-center">
            <div class=swiper-slide>
                <picture>
                    <source srcset="<?php echo e(asset('build/client/images/mckup/sindacs-mobile.webp')); ?>" media="(max-width: 600px)" type=image/webp>
                    <source srcset="<?php echo e(asset('build/client/images/mckup/sindacs.webp')); ?>" type=image/webp>
                    <img src="<?php echo e(asset('build/client/images/mckup/sindacs.webp')); ?>" alt="Hey Arte" title="Hey Arte" loading=lazy style=width:100%;max-width:300px;height:auto;object-fit:cover;border-radius:35px>
                </picture>
            </div>
            <div class=swiper-slide>
                <picture>
                    <source srcset="<?php echo e(asset('build/client/images/mckup/hey-arte-mobile.webp')); ?>" media="(max-width: 600px)" type=image/webp>
                    <source srcset="<?php echo e(asset('build/client/images/mckup/hey-arte.webp')); ?>" type=image/webp>
                    <img src="<?php echo e(asset('build/client/images/mckup/hey-arte.webp')); ?>" alt="Hey Arte" title="Hey Arte" loading=lazy style=width:100%;max-width:300px;height:auto;object-fit:cover;border-radius:35px>
                </picture>
            </div>
            <div class=swiper-slide>
                <picture>
                    <source srcset="<?php echo e(asset('build/client/images/mckup/flygo-mobile.webp')); ?>" media="(max-width: 600px)" type=image/webp>
                    <source srcset="<?php echo e(asset('build/client/images/mckup/flygo.webp')); ?>" type=image/webp>
                    <img src="<?php echo e(asset('build/client/images/mckup/flygo.webp')); ?>" alt="Flygo Turismo" title="Flygo Turismo" loading=lazy style=width:100%;max-width:300px;height:auto;object-fit:cover;border-radius:35px>
                </picture>
            </div>
            <div class=swiper-slide>
                <picture>
                    <source srcset="<?php echo e(asset('build/client/images/mckup/anilda-mobile.webp')); ?>" media="(max-width: 600px)" type=image/webp>
                    <source srcset="<?php echo e(asset('build/client/images/mckup/anilda.webp')); ?>" type=image/webp>
                    <img src="<?php echo e(asset('build/client/images/mckup/anilda.webp')); ?>" alt="Anilda Advogado" title="Anilda Advogado" loading=lazy style=width:100%;max-width:300px;height:auto;object-fit:cover;border-radius:35px>
                </picture>
            </div>
            <div class=swiper-slide>
                <picture>
                    <source srcset="<?php echo e(asset('build/client/images/mckup/hive-mobile.webp')); ?>" media="(max-width: 600px)" type=image/webp>
                    <source srcset="<?php echo e(asset('build/client/images/mckup/hive.webp')); ?>" type=image/webp>
                    <img src="<?php echo e(asset('build/client/images/mckup/hive.webp')); ?>" alt=Hive title=Hive loading=lazy style=width:100%;max-width:300px;height:auto;object-fit:cover;border-radius:35px>
                </picture>
            </div>
            <div class=swiper-slide>
                <picture>
                    <source srcset="<?php echo e(asset('build/client/images/mckup/eau-sports-mobile.webp')); ?>" media="(max-width: 600px)" type=image/webp>
                    <source srcset="<?php echo e(asset('build/client/images/mckup/eau-sports.webp')); ?>" type=image/webp>
                    <img src="<?php echo e(asset('build/client/images/mckup/eau-sports.webp')); ?>" alt="EAU Sports" title="EAU Sports" loading=lazy style=width:100%;max-width:300px;height:auto;object-fit:cover;border-radius:35px>
                </picture>
            </div>
            <div class=swiper-slide>
                <picture>
                    <source srcset="<?php echo e(asset('build/client/images/mckup/painel-gerenciador-mobile.webp')); ?>" media="(max-width: 600px)" type=image/webp>
                    <source srcset="<?php echo e(asset('build/client/images/mckup/painel-gerenciador.webp')); ?>" type=image/webp>
                    <img src="<?php echo e(asset('build/client/images/mckup/painel-gerenciador.webp')); ?>" alt="Painel gerenciador de conteúdo" title="Painel gerenciador de conteúdo" loading=lazy style=width:100%;max-width:300px;height:auto;object-fit:cover;border-radius:35px>
                </picture>
            </div>
        </div>
        <div class=swiper-pagination></div>
...
<i class="bi bi-whatsapp rounded-circle d-flex justify-content-center align-items-center"></i>
    ...
    <img src="<?php echo e(asset('build/client/images/firula-transformed.webp')); ?>" alt=firula-transformed title=firula-transformed class="position-absolute bottom-0 w-auto img-fluid d-block" data-aos=fade-up data-aos-delay=200 loading=lazy>
</section>
<section id=trust-whi class="trust-whi position-relative py-5 trust-whi-background">
    <img src="<?php echo e(asset('build/client/images/hand.png')); ?>" alt="image of hand" title="image of hand" class="position-absolute top-0 hand" data-aos=fade-left data-aos-delay=950 loading=lazy>
                ...
                <div class="carousel-trust-whi swiper-wrapper align-items-center py-2 px-2">
                    <div class=swiper-slide>
                        <div class="trust-whi-list-item bg-white p-4 rounded-4 border border-dark">
                            <img src="<?php echo e(asset('build/client/images/aspas-left.svg')); ?>" alt="Aspas Left" title="Aspas Left" class=apas-left loading=lazy>
                            ...
                            <img src="<?php echo e(asset('build/client/images/aspas-right.svg')); ?>" alt="Aspas Right" title="Aspas Right" class=apas-right loading=lazy>
                        </div>
                    </div>
                    <div class=swiper-slide>
                        <div class="trust-whi-list-item bg-white p-4 rounded-4 border border-dark">
    ...
    <div class="max-width m-auto d-flex flex-column flex-md-row justify-content-between align-items-center py-4">
        <div class="content-lef col-12 col-md-4 text-center text-md-end">
            ...
            <div class="position-relative d-flex justify-content-center flex-column align-items-center">
                <img src="<?php echo e(asset('build/client/images/robot-hand.png')); ?>" alt="Mão de robô com lâmpada" title="Mão de robô com lâmpada" class="w-100 robot-lamp m-auto me-md-5 d-none d-md-block" loading=lazy>
                <a href=https://wa.me/5571996483853 target=_blank rel="noopener noreferrer" class="mt-0 rethink-sans-regular ps-5 text-white call-to-action d-flex justify-content-between align-items-center">
                Fale com a gente!
                <i class="bi bi-whatsapp rounded-circle d-flex justify-content-center align-items-center"></i>
                </a>
    ...
    <div class=me-5>
        <div class="d-flex flex-wrap">
            <div class=col-md-6 data-aos=zoom-in data-aos-delay=150>
                ...
                <div class=img>
                    <img src="<?php echo e(asset('build/client/images/hand-faq.png')); ?>" alt=hand-faq title=hand-faq class="img-fluid mt-3 hand-faq" loading=lazy>
                </div>
            </div>
            <div class=col-md-6>
                <div class=answer>
            ...
            <div class="row align-items-center mb-5">
                <div class="col-lg-4" data-aos="fade-right" data-aos-delay="250">
                    <div class="section-title">
                        ...
                        <a href="<?php echo e(route('blog')); ?>" class="btn btn-primary-custom">
                            ...
                            <div class="col-md-4">
                                <div class="blog-card">
                                    <div class="card-img-container">
                                        <span class="card-category"><?php echo e($blogHighlight->category->title); ?></span>
                                        <img src="<?php echo e($blogHighlight->path_image_thumbnail ? asset('storage/'.$blogHighlight->path_image_thumbnail) : 'https://placehold.co/600x400?text=Sem+imagem&font=montserrat'); ?>"
                                       alt="<?php echo e($blogHighlight->title ? $blogHighlight->title : 'Sem imagem'); ?>">
                                    </div>
                                    <div class="card-body-custom">
                                        <h5 class="d-block text-uppercase rethink-sans-bold font-16 title-blue"><?php echo e($blogHighlight->title); ?></h5>
                                        <p class="text-color rethink-sans-regular font-16">
                                            <?php echo e(substr(strip_tags($blogHighlight->text), 0, 100)); ?>...
                                        </p>
                                        <a href="<?php echo e(route('blog-inner', ['slug' => $blogHighlight->slug])); ?>" class="read-more">
...
<?php echo $__env->make('client.core.client', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\wagner\site-whi-with-blog\resources\views/client/blades/index.blade.php ENDPATH**/ ?>