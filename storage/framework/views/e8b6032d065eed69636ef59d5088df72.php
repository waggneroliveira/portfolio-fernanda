...
<head>
    ...
    <link rel="preload" as="image" href="<?php echo e(asset('build/client/images/banner.webp')); ?>">
    <link rel="preload" as="image" href="<?php echo e(asset('build/client/images/banner-mob.webp')); ?>">
    ...
    <header id="header" class="py-4 py-sm-5 position w-100 d-flex align-items-center justify-content-between flex-row max-width m-auto">
        <div class="logo-img">
            <a href="<?php echo e(route('index')); ?>">
                <img src="<?php echo e(asset('build/client/images/logo.png')); ?>" alt="WHI -Web de Alta Inovação" title="WHI -Web de Alta Inovação" class="img-fluid" loading="lazy">
            </a>
        </div>
                ...
                <div class="modal-content header-color">
                    ...
                    <div class="modal-body">
                        <form action="<?php echo e(route('client.update')); ?>" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="mb-3">
                                <label for="name" class="form-label rethink-sans-bold font-15 text-white">Nome</label>
                                <input type="text" class="form-control rethink-sans-regular font-15" id="name" name="name" value="<?php echo e(Auth::guard('client')->user()->name); ?>" required>
                            </div>

                            <div class="mb-3">
                                <label for="emailRegister" class="form-label rethink-sans-bold font-15 text-white">E-mail</label>
                                <input type="email" class="form-control rethink-sans-regular font-15" id="emailRegister" name="email" value="<?php echo e(Auth::guard('client')->user()->email); ?>" required>
                            </div>
                            ...
                            <div class="col-lg-12">
                                <div class="mt-3">
                                    ...
                                    />
                                    <p class="rethink-sans-regular text-white font-12 mt-2 mb-0"><?php echo e(__('dashboard.text_img_size')); ?> <b class="text-danger">2 MB</b>.</p>
                                </div>
                            </div>
        ...
        <div class="container py-5">
            <div class="sitemap mt-2 mb-5 row row-cols-1 row-cols-sm-2 row-cols-md-3 row-cols-lg-4 row-cols-xl-6 g-3 justify-content-between align-items-center">
                <div class="logo logo-footer">
                    <a href="<?php echo e(route('index')); ?>">
                        <img src="<?php echo e(asset('build/client/images/logo.png')); ?>" alt="WHI - Web de Alta Inovação" title="WHI - Web de Alta Inovação" loading="lazy">
                    </a>
                </div>
...
</html><?php /**PATH C:\laragon\www\wagner\site-whi-with-blog\resources\views/client/core/client.blade.php ENDPATH**/ ?>