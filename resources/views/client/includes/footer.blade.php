    ...
    <div class="bg-footer">
        <div class="container">
            <div class="mry-main-title mry-title-center">
                ...
                <div class="mry-fo">
                    <a href="{{route('contact')}}" class="mry-anima-link mry-btn mry-btn-color mry-default-link">Fale comigo</a>
                    <a href="{{route('portfolio')}}" class="mry-anima-link  mry-btn-text mry-default-link">Portfólio</a>
                </div>
            </div>
        </div>
    </div>
