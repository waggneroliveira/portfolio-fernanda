														...
														<div class="mry-card-cover-frame mry-mb-10 mry-fo">
															...
															<div class="mry-hover-links">
																<a href="{{ asset('storage/' . $gallery->path_image) }}" data-fancybox="works"
																	class="mry-zoom mry-magnetic-link">
											...
											<div class="swiper-slide">
												...
												<div class="mry-card-item">
													<div class="mry-card-cover-frame mry-mb-20 mry-fo">
														...
														<div class="mry-cover-overlay"></div>
														<div class="mry-hover-links">
															<a href="{{asset('storage/'.$relatedProject->path_image)}}" data-fancybox="works-slider" class="mry-zoom mry-magnetic-link"><span
																	class="mry-magnetic-object"><i class="fas fa-expand"></i></span></a>
															<a href="{{route('project', $relatedProject->slug)}}" class="mry-more mry-magnetic-link mry-anima-link"><span class="mry-magnetic-object"><i
